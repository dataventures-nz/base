...
export const auth0Promise =
	typeof window !== 'undefined' ? createAuth0Client(auth_config) : new Promise(() => {});
...
export const logout = () =>
	auth0Promise.then((auth0) => auth0.logout({ returnTo: window.location.origin }));

...
export const userPromise = () => auth0Promise.then(async auth0 => {await auth0.getTokenSilently(); return await auth0.getUser()})
export const idTokenClaimsPromise = () => auth0Promise.then(async auth0 => {await auth0.getTokenSilently(); return await auth0.getIdTokenClaims()})
